...
const historyData = [
  {
    ...
    image: "https://lh3.googleusercontent.com/d/1d77HJkTTxJQe6VYvsD5UTwY9_Skcm6Sv",
    description: {
  ...
  },
  {
    ...
    image: "https://lh3.googleusercontent.com/d/1VfQVRFesaC5MuokfZuLyKZMzyt1XQvDI",
    description: {
...
<<<<<<< HEAD
              ...
              />
=======
              <img src={item.image} alt={item.title[language]} className="mb-3" style={{ display: 'block', width: '70%', height: 'auto', margin: 'auto' }} />
>>>>>>> 2f139f26c8534d8843b20ae5a02a5ef1c3580f6b
